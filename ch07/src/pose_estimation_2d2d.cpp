...
/**
 * @brief 2d-2d pose estimation, essential matrix & homograpy matrix
 *
 * @param keypoints_1
 * @param keypoints_2
 * @param matches
 ...
 * @param matches, results
 */
void find_ORB_feature_matches(const cv::Mat &img_1, const cv::Mat &img_2,
                          std::vector<cv::KeyPoint> &keypoints_1,
                          std::vector<cv::KeyPoint> &keypoints_2,
                          std::vector<cv::DMatch> &matches)
{
    ...
    // init ORB detector, descriptor, matcher
    // used in OpenCV3
